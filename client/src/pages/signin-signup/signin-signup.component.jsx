...
const SignInSignUp = () => {
    ...
    let htmlToShow = (<><SignIn /><SignUp /></>);

    if (smallDevice) {
        if (showSignin) {
            htmlToShow = (<><SignIn /><TextAsLink clickHandler={onClickHandler} text="Dont have an account yet?" /></>);
        } else {
            htmlToShow = (<><SignUp /><TextAsLink clickHandler={onClickHandler} text="Take me to login!" /></>);
        }
    }
